...
public class HttpLoggingInterceptor implements Interceptor {
    ...
    private void logForRequest(Request request, Connection connection) throws IOException {
        ...
        boolean logHeaders = (level == HttpLoggingInterceptor.Level.BODY || level == HttpLoggingInterceptor.Level.HEADERS);
        ...
        try {
            ...
            LogUtils.i("请求体:" + requestStartMessage);
            ...
            if (logHeaders) {
                ...
                if (logBody && HttpHeaders.hasBody(clone)) {
                    if (isPlaintext(responseBody.contentType())) {
                        ...
                        log("\tbody:" + body);
                        LogUtils.i("请求连接:" + URLDecoder.decode(clone.request().url().url().toString(), UTF8.name()),
                                "响应体:" + body);
    ...
    private void bodyToString(Request request) {
        try {
            ...
            LogUtils.i("requestBody:", URLDecoder.decode(replacer(result), UTF8.name()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
